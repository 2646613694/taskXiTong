package com.jumpower.taskxitong.common;
...
/**
 * DateUtil 类主要是提供了对日期操作的一些方法，主要是指日期类型与字符型的转换DATETIME_FORMAT；<br>
 * 日期的比较、日期的输入格式化等。
 * @author ktamr
 * @date 2019年7月10日
 * @website wwww.com.ktamrinterface
 */
public class DateUtils {
    ...
    public static String getFormerly(int i){
    ...
    {
        return dateTimeNow(DATETIME_FORMAT);
    }
    ...
    public static final String getTimeHH()
    {
